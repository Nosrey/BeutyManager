...
function BuscarProducto({ productos, filtrarProductos, productosFiltrados, setInput1, input1, input2, filtrarCategorias }) {
    ...
    return (
        <div className="m-2">
            ...
            <label><strong className='m-0 text-lg bg-sky-500 text-white px-2 py-1 rounded-md border border-l-0 border-slate-400 rounded-l-none'>Buscar producto</strong></label>
        </div>
    )
}
