...
export default function HeaderVentas() {
    ...
    return (
        <div className={"min-h-[20vh] md:min-h-[40vh] xl:min-h-[25vh] xl:h-[80vh] bg-orange-500 xl:flex-row items-center xl:justify-between  py-0 pt-0 xl:pt-0 bg-[length:auto_100vh] md:bg-[length:auto_100vh] bg-[length:auto_25vh] md:bg-[length:100%_auto] xl:bg-[length:100vw_auto] bg-[position:center_0] xl:bg-[position:center_0%] xl:bg-contain md:bg-top bg-fixed  shadow-md md:rounded-xl md:rounded-t-none bg-[url(" + bannerVentas3 + ")] xl:bg-[url(" + bannerVentas + ")]"}>
            ...
            <div>
                <div className='xl:hidden flex flex-col justify-center items-center'>
                    ...
                    <button className='w-[8vw] md:w-[6vw] mt-[2vh] md:mt-0 md:py-10' onClick={
                        () => {
