...
function BuscarCategorias({ filtrarCategorias, productos, productosFiltrados, setInput2, input2, input1, filtrarProductos, }) {
    ...
    return (
        <div className="m-2 text-xl">
            ...
            <label><strong className='m-0 text-lg bg-sky-500 text-white px-2 py-1 rounded-md border border-l-0 border-slate-400 rounded-l-none text-xl shadow-sm '>Buscar categorias</strong></label>
        </div>
    )
}
